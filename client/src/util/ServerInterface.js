...
export const episodes = (showList, completedCallBack, errorCallBack) => {
  send(EPISODES_URL + SHOWS_QRY(showList), completedCallBack, errorCallBack);
};
...
export const banner = (showId) => new Promise((resolve, reject) => {
